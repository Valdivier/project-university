...
@section('content')
		<div class="wrapper">
			...
			<div id="content_hero" style="background-image: url(images/hero-news-single.jpg)">
					...
					<div class="col-sm-6">
						<form method="POST" action="{{route('register')}}"  enctype="multipart/form-data">
							...
							<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}"">
								...
								<input  id="name" type="text" class="form-control" name="name" value="{{ old('name') }}" required autofocus required placeholder="Ingrese su nombre">
							...
							<div class="form-group{{ $errors->has('lastname') ? ' has-error' : '' }}"">
								...
								<input  id="lastname" type="text" class="form-control" name="lastname" value="{{ old('lastname') }}" required autofocus required placeholder="Ingrese sus apellidos">
							...
							<div class="form-group">
								...
								<input id="password-confirm" type="password" class="form-control" name="password_confirmation" required required placeholder="Repite la contraseña ingresada anteriormente"> 
							</div>

							<div class="form-group">
	                                                            
	                            <label class="text-dark">Foto de perfíl</label>
